...
describe('CommentController/delete (e2e)', () => {
  ...
  it('/cards/:id/comments (DELETE) Should delete a comment', async () => {
  ...
  it('/cards/:id/comments (DELETE) Should return 403 if the user is not the comment author', async () => {
    const user = await new UserBuilder().persist(prisma)
